...
<head>
  <meta charset="utf-8" />
  <!-- <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets/img/logo-PNG.png') }}"> -->
  <!-- <link rel="icon" type="image/png" href="{{ asset('assets/img/logo-PNG.png') }}"> -->
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
  <title>
  @yield('title') | CV. Global Solusindo
  </title>
      ...
      <div class="modal-dialog modal-small">
        <div class="modal-content">
          ...
          <div class="modal-footer justify-content-center">
            <button type="button" class="btn btn-link" data-dismiss="modal">No!Forget</button>
            <a class="btn btn-success btn-link" href="">Yes<div class="ripple-container"></div></a>
          </div>
        </div>
      </div>
    </div>
    ...
    -->
      <div class="logo">
        <a href="#" class="simple-text logo-mini">
          <!-- <img src="{{ asset('assets/img/logo-PNG.png') }}" width="25" height="25"> -->
        </a>
        <a href="#" class="simple-text logo-normal" style="font-size: 14px;">
          WEBGIS VAKSIN COVID-19
        </a>
      </div>
      ...
      <footer class="footer hide">
        ...
        <div class="container-fluid">
          <div class="copyright float-right">
            ...
            <a href="https://www.tigaconsulting.co.id" target="_blank">Sase Aditya.</a>
          </div>
        </div>
      </footer>
    </div>
